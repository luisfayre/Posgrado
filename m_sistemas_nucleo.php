        ...
        <div class="container" style="text-align:justify;">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <p>El núcleo académico básico está compuesto por nueve profesores, tres de ellos con doctorado y el resto con el grado de maestría. Los docentes son:
                    </p>
                </div>
            </div>
            <!-------------------------------------------------------------------------->
            ...
            <div class="thumbnail marcos">
                <div class="media-left media-middle">
                    <a href="#">
                        <img class="media-object" src="img/cv/vazquez (copia).jpg" alt="Vazquez" width="100" height="160">
                    </a>
                </div>
                <div class="media-body">
                    <h4 class="media-heading">Rafael Vazquez Perez</h4>
                    <p>rvazquez.perez@me.com </p>
                    <p>
                    <table>
                        <tr>
                            <td>16/12/1988 </td>
            ...
            <div class="thumbnail marcos">
                <div class="media-left media-middle">
                    <a href="#">
                        <img class="media-object" src="img/cv/blanca.png" alt="Blanca" width="100" height="160">
                    </a>
                </div>
                <div class="media-body">
                    ...
                    <table>
                        <tr>
                            <td> 25/10/2006 </td>
                            <td><strong> Maestría</strong>, en Ciencias en Enseñanzas de las Ciencias. Centro Interdisciplinario de Investigación y Docencia en Educación (CIIDET).</td>
                        </tr>
                        <tr>
                            <td> 26/10/2011 </td>
