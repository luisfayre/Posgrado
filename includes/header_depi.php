...
<!--div class="inner-wrap">
    <div class="header1-widget-zone"><a href="https://www.gob.mx/" id="" target="_self"
                                        class="widget_sp_image-image-link" title="">
            <img width="100" height="31" alt="" class="attachment-100x31 alignleft" style="max-width: 100%;" src="img/logos/gob.png"></a>
    </div>
</div>

<div class="header-image-wrap">
    <div class="inner-wrap">
        <img src="img/cropped-header-trans-2.png" class="header-image" width="1500" height="233" 
             alt="Instituto Tecnologico de Chihuahua II">
    </div>
</div-->
